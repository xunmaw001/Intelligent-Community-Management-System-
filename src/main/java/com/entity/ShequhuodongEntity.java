...
public class ShequhuodongEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Shequhuodong{" +
            "id=" + id +
            ", shequhuodongUuidNumber=" + shequhuodongUuidNumber +
            ", shequhuodongName=" + shequhuodongName +
            ", shequhuodongPhoto=" + shequhuodongPhoto +
            ", shequhuodongKaishiTime=" + shequhuodongKaishiTime +
            ", shequhuodongJieshuTime=" + shequhuodongJieshuTime +
            ", shequhuodongTypes=" + shequhuodongTypes +
            ", shequhuodongContent=" + shequhuodongContent +
            ", shangxiaTypes=" + shangxiaTypes +
            ", shequhuodongDelete=" + shequhuodongDelete +
