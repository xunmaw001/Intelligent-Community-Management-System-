...
public class GonggongchangsuoLiuyanView extends GonggongchangsuoLiuyanEntity implements Serializable {
	...
	public GonggongchangsuoLiuyanView() {

	}

	public GonggongchangsuoLiuyanView(GonggongchangsuoLiuyanEntity gonggongchangsuoLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, gonggongchangsuoLiuyanEntity);
