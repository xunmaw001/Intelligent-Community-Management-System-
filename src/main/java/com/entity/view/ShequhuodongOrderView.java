...
public class ShequhuodongOrderView extends ShequhuodongOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核状态的值
		*/
		private String shequhuodongOrderYesnoValue;
	...
	public ShequhuodongOrderView() {

	}

	public ShequhuodongOrderView(ShequhuodongOrderEntity shequhuodongOrderEntity) {
		try {
			BeanUtils.copyProperties(this, shequhuodongOrderEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getShequhuodongOrderYesnoValue() {
				return shequhuodongOrderYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setShequhuodongOrderYesnoValue(String shequhuodongOrderYesnoValue) {
				this.shequhuodongOrderYesnoValue = shequhuodongOrderYesnoValue;
			}
