...
public class ShequhuodongLiuyanView extends ShequhuodongLiuyanEntity implements Serializable {
	...
	public ShequhuodongLiuyanView() {

	}

	public ShequhuodongLiuyanView(ShequhuodongLiuyanEntity shequhuodongLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, shequhuodongLiuyanEntity);
