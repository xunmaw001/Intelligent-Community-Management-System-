...
public class GonggongchangsuoOrderView extends GonggongchangsuoOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核状态的值
		*/
		private String gonggongchangsuoOrderYesnoValue;
	...
	public GonggongchangsuoOrderView() {

	}

	public GonggongchangsuoOrderView(GonggongchangsuoOrderEntity gonggongchangsuoOrderEntity) {
		try {
			BeanUtils.copyProperties(this, gonggongchangsuoOrderEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getGonggongchangsuoOrderYesnoValue() {
				return gonggongchangsuoOrderYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setGonggongchangsuoOrderYesnoValue(String gonggongchangsuoOrderYesnoValue) {
				this.gonggongchangsuoOrderYesnoValue = gonggongchangsuoOrderYesnoValue;
			}
