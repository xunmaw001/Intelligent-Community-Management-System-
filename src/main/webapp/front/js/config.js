...
var centerMenu = [
    ...
    ,{
        name: '公共场所收藏',
        url: '../gonggongchangsuoCollection/list.html'
    }
    ,{
        name: '公共场所预约',
        url: '../gonggongchangsuoOrder/list.html'
    }
    ,{
        name: '社区活动收藏',
        url: '../shequhuodongCollection/list.html'
    }
    ,{
        name: '社区活动预约',
        url: '../shequhuodongOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '安保维护',
        url: './pages/anbaoweihu/list.html'
    },
    {
        name: '论坛',
    ...
    {
        name: '公共场所',
        url: './pages/gonggongchangsuo/list.html'
    },
    {
        name: '留言板',
    ...
    {
        name: '政务服务',
        url: './pages/zhengwufuwu/list.html'
    },

]

var adminurl =  "http://localhost:8080/zhinnengshequguanli/admin/dist/index.html#/login";
